...
bpsys_linear2 = lm(sys_mean~I(ridageyr^2)+I(lbxglu^(1/3))+log(lbxtc)+log(bmxsad1)+log(bmxwaist)+bmxbmi+riagendr+diq010+lbdldl+ridageyr:lbdldl+bmxwt:ridageyr+bmxarml:ridageyr,sys_lin)
