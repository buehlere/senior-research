...
ggplot(sys_imp, aes(y=Overall, x=reorder(X1,Overall),fill="red")) + 
  ...
  scale_x_discrete(labels=c("Asian","Hispanic","White","LDL Chol.","HDL Chol.","Diabetes","Cholesterol","Black","Leg Circum.","Lower Arm Circum.","Gender","Glucose","Abdomin Circum.","Upper Arm Circum.", "Height","BMI","Hypertension Med.","Waist Circum.","Weight","Hypertension","Age")) +   labs(x="Predictor", y="Importance to Systolic") +
