...
#### DV: Blood Pressure 
  ...
  dv_bp <- bloodpressure.XPT %>% select(seqn,bpxsy1,bpxsy2,bpxsy3,bpxdi1,bpxdi2,bpxdi3)
  
  ### throwing out outliers
  dv_bp <- dv_bp %>% filter(bpxsy1,bpxsy2,bpxsy3,bpxdi1,bpxdi2,bpxdi3 != 0 & bpxsy1,bpxsy2,bpxsy3,bpxdi1,bpxdi2,bpxdi3 < 200 & bpxdi1,bpxdi2,bpxdi3 > 25)
